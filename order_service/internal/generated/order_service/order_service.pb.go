...
const file_order_service_order_service_proto_rawDesc = "" +
	"\n" +
	"!order_service/order_service.proto\x12\rorder_service\x1a\x1fgoogle/protobuf/timestamp.proto\"f\n" +
	"\x12CreateOrderRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x127\n" +
	"\n" +
	"cart_items\x18\x02 \x03(\v2\x18.order_service.CartItemsR\tcartItems\"A\n" +
	"\x13CreateOrderResponse\x12*\n" +
	"\x05order\x18\x01 \x01(\v2\x14.order_service.OrderR\x05order\">\n" +
	"\tCartItems\x12\x15\n" +
	"\x06sku_id\x18\x01 \x01(\tR\x05skuId\x12\x1a\n" +
	"\bquantity\x18\x02 \x01(\x05R\bquantity\"\x95\x02\n" +
	"\x05Order\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status\x12%\n" +
	"\x0epayment_method\x18\x04 \x01(\tR\rpaymentMethod\x12.\n" +
	"\x05items\x18\x05 \x03(\v2\x18.order_service.OrderItemR\x05items\x129\n" +
	"\n" +
	...
	"\bquantity\x18\x04 \x01(\x05R\bquantity2d\n" +
	"\fOrderService\x12T\n" +
	"\vCreateOrder\x12!.order_service.CreateOrderRequest\x1a\".order_service.CreateOrderResponseB\x19Z\x17generated/order_serviceb\x06proto3"
